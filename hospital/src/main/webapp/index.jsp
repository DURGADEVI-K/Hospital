...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/hos.jpg" class="d-block w-100" alt="..." height="600px">
    </div>
					...
					<div class="col-md-6">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Achieving 100% safety is an ambitious goal, especially in complex systems or environments</p>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Creating and maintaining a clean environment in crucial for ensuring safety and promoting health </p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p> A friendly doctor dedicated to providing personalized care with patient</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Medical research aims to improving patient outcomes and public health.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr.Pavithra</p>
